...
// TODO: merge this with main bundle

// CBundle contains configuration specific to an API and global server properties
...
func (bnd CBundle) ServerBase() string {
	base := bnd.g.URIBase
...
func (bnd CBundle) Has(key string) bool {
...
func (bnd CBundle) Name() string {
	return bnd.Get(ConfigKeyAPIName)
}
...
func (bnd CBundle) APIBase() string {
	base := bnd.Get(ConfigKeyAPIBase)
...
func (bnd CBundle) UsesDBs() []string {
	return bnd.GetSlice(ConfigKeyAPIUsesDBs)
}
...
func (bnd CBundle) Enabled() bool {
	return bnd.GetBool(ConfigKeyAPIEnabled)
}
...
func (bnd CBundle) Get(key string) string {
	var v string
	...
	return configGet[string](bnd.api, key)
}
...
func (bnd CBundle) GetByteSlice(key string) []byte {
	var v []byte
	...
	return configGet[[]byte](bnd.api, key)
}

// GetSlice retrieves the value of a []string-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetSlice(key string) []string {
	var v []string
...
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetIntSlice(key string) []int {
	var v []int
	...
	return configGet[[]int](bnd.api, key)
}

// GetBoolSlice retrieves the value of a []bool-typed API configuration key. If
// it doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetBoolSlice(key string) []bool {
	var v []bool
	...
	return configGet[[]bool](bnd.api, key)
}
...
func (bnd CBundle) GetFloatSlice(key string) []float64 {
	var v []float64
	...
	return configGet[[]float64](bnd.api, key)
}

// GetBool retrieves the value of a bool-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetBool(key string) bool {
	var v bool
...
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetFloat(key string) float64 {
	var v float64
...
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetTime(key string) time.Time {
	var v time.Time
	...
	return configGet[time.Time](bnd.api, key)
}

// GetInt retrieves the value of an int-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetInt(key string) int {
	var v int
...
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetInt8(key string) int8 {
	var v int8
	...
	return configGet[int8](bnd.api, key)
}

// GetInt16 retrieves the value of an int16-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetInt16(key string) int16 {
	var v int16
	...
	return configGet[int16](bnd.api, key)
}

// GetInt32 retrieves the value of an int32-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetInt32(key string) int32 {
	var v int32
	...
	return configGet[int32](bnd.api, key)
}

// GetInt64 retrieves the value of an int64-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetInt64(key string) int64 {
	var v int64
	...
	return configGet[int64](bnd.api, key)
}

// GetUint retrieves the value of a uint-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetUint(key string) uint {
	var v uint
	...
	return configGet[uint](bnd.api, key)
}

// GetUint8 retrieves the value of a uint8-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetUint8(key string) uint8 {
	var v uint8
	...
	return configGet[uint8](bnd.api, key)
}

// GetUint16 retrieves the value of a uint16-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetUint16(key string) uint16 {
	var v uint16
	...
	return configGet[uint16](bnd.api, key)
}

// GetUint32 retrieves the value of a uint32-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetUint32(key string) uint32 {
	var v uint32
	...
	return configGet[uint32](bnd.api, key)
}

// GetUint64 retrieves the value of a uint64-typed API configuration key. If it
// doesn't exist in the config, the zero-value is returned.
func (bnd CBundle) GetUint64(key string) uint64 {
	var v uint64
	...
	return configGet[uint64](bnd.api, key)
}
